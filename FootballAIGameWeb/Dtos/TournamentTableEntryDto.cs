...
using System.Linq;
using System.Web;
using FootballAIGameWeb.Controllers.Api;
using FootballAIGameWeb.Models;

namespace FootballAIGameWeb.Dtos
{
    /// <summary>
    /// <see cref="Tournament"/> data access object that is returned from the <see cref="GameController.GetJoinedTournaments"/> service.
    /// </summary>
